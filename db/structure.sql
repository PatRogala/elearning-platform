...
CREATE TABLE public.users (
    ...
    created_at timestamp(6) with time zone NOT NULL,
    updated_at timestamp(6) with time zone NOT NULL,
    fullname character varying DEFAULT 'John Doe'::character varying NOT NULL,
...
--
-- Name: index_faq_items_on_question; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX index_faq_items_on_question ON public.faq_items USING btree (question);
